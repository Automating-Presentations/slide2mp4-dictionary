...
A dictionary file for slide2mp4 is a text file containing words and pronunciations, and the words and pronunciations must be separated by tabs or spaces. In a dictionary file, lines starting with "#" are recognized as comments. As a side note, in order to make each line of this slide2mp4-dic-XX.txt unique, words and pronunciations are separated by a single tab.
